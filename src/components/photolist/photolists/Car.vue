        ...
        <div id="slider" class="mui-slider">
            <div id="sliderSegmentedControl" class="mui-scroll-wrapper mui-slider-indicator mui-segmented-control mui-segmented-control-inverted">
                <div class="mui-scroll">
                    ...
                    <a class="mui-control-item" @click.prevent="ToOutdoor()" >
                        户外
                    </a>
                    ...
                    <a class="mui-control-item mui-active" @click.prevent="ToCar()">
                        汽车
                    </a>
...
export default {
    ...
    methods: {
        getRecom() {
            ...
            // var api = 'https://api.dujin.org/pic/'
            this.$http.get(api).then((res)=>{
                this.list = res.data.message5;
                console.log(res)
            }).catch((err)=>{
                console.log(err)
            })
        ...
        getRecoms() {
            var api = '/static/data/photolist.json'  
            this.$http.get(api).then((res)=>{
                this.list = this.list.concat(res.data.message5); //数组拼接
